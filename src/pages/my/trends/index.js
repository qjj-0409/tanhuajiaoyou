...
import { MY_TRENDS, BASE_URI } from '../../../utils/pathMap'
                ...
                <View style={{flexDirection: 'row', alignItems: 'center'}}>
                  ...
                  >
                    ...
                    >
                      ...
                      />
                      <Text style={{ color: '#787878' }}>{user.age}岁</Text>
                    </View>
                    <View style={{ flexDirection: 'row' }}>
                      <Text style={{ color: '#787878' }}>{user.marry}</Text>
                      <Text style={{ color: '#787878' }}> | </Text>
                      <Text style={{ color: '#787878' }}>{user.xueli}</Text>
                      <Text style={{ color: '#787878' }}> | </Text>
                      <Text style={{ color: '#787878' }}>
                        {user.agediff < 10 ? '年龄相仿' : '有点代沟'}
                      </Text>
                    </View>
                  </View>
                </View>
